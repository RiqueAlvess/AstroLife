"""
Django settings for astrolife project.
...
SECRET_KEY = "django-insecure-hnpam6r!dip+ypof3g4x4&%r1=+^+#h^lx0&-#(npsyz)8pk=1"
...
WSGI_APPLICATION = "astrolife.wsgi.application"
